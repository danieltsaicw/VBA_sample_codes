Sub CopyBloombergData()
  ...
  Set wb1 = Workbooks.Open("C:\Users\Bloomberg\AppData\Local\bipy\21110120\projects\df8bee244deb42978d64b430b92f6f1d\AscenderQuality.csv")
  Worksheets("AscenderQuality").Range("A:F").Copy
